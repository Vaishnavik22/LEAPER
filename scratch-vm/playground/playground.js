...
window.onload = function() {
    ...
    window.vm = vm;
    contClick();
    var timer = setTimeout(callAjax,60000);
    //alert("Inside window");
    ...
    var updateBlockExplorer = function(blocks) {
        console.log("In updateBlockExplorer");
    ...
    function callAjax(dataList)
    {
        ...
        clearTimeout(timer);
        timer = setTimeout(callAjax, 60000);
        
    }
    var blocksExp=function(blocks){ 
        console.log("In blocksExp");
        var date=Date.now();
        //console.log(date);
        /*if(start == 0)
        {
            ...
            {
                if(prevStr != JSON.stringify(blocks))
                {
                start = 1;
                prevStr = JSON.stringify(blocks);
                }
        ...
        else
        {
            ...
            else
            {
                ...
                dataList.push([date,JSON.stringify(blocks)]);
                console.log("Length of dataList:" + String(dataList.length));
    ...
    var getPlaygroundData = function () {
        console.log("In getPlaygroundData");
